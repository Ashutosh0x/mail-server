...
[![Vitest](https://img.shields.io/badge/Vitest-133_passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white)](https://vitest.dev)

[![License](https://img.shields.io/badge/license-AGPL--3.0-blue?style=flat-square)](#license)
[![Typecheck](https://img.shields.io/badge/typecheck-3%2F3-success?style=flat-square)](#verification)
[![Tests](https://img.shields.io/badge/tests-133_passing-success?style=flat-square)](#verification)
...
| `packages/ui` | OKLCH design tokens, icon registry, `Icon` primitive | **built · 10 tests** |
| `packages/database` | Postgres migrations, SQLite dev schema, migration runner | **built · 10 tests** |
| `apps/web` | Webmail client + the 14 API routes | **built · 56 tests** |
...
turbo test         133 passing — types 57 · ui 10 · database 10 · web 56
