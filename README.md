...
[![Vitest](https://img.shields.io/badge/Vitest-296_passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white)](https://vitest.dev)

[![License](https://img.shields.io/badge/license-AGPL--3.0-blue?style=flat-square)](#license)
[![Typecheck](https://img.shields.io/badge/typecheck-3%2F3-success?style=flat-square)](#verification)
[![Tests](https://img.shields.io/badge/tests-296_passing-success?style=flat-square)](#verification)
...
```bash
npm install
npm test                                   # 296 tests across four packages
...
| `apps/web` | Webmail client, security center, storage providers, 25 API routes | **built · 196 tests** |
...
turbo test         296 passing — types 57 · ui 33 · database 10 · web 196
